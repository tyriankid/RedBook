...
namespace ASPNET.WebControls
{
    ...
    {
        private string m_FlashUploadType = "shopimg";
        ...
        private string AC2pFbvHCa1v4C1DIZ8SngolueQb(string text1)
        {
            ...
            if (str.Contains("/temp/") && (str.Length > 10))
            {
                ...
                string str3 = Globals.UPLOAD_PATH + this.m_FlashUploadType;
        ...
        private string MyTest(string text1)
        {
            ...
            foreach (string str2 in strArray)
            {
                if (str2.StartsWith("http://") && !str2.StartsWith("http://images.net.92hidc.com"))
                {
                    ...
                    builder.Append(str2.Replace("http://" + strArray2[2] + "/" +strArray2[3] + "/" +strArray2[4] +"/", "").Trim() + ",");
                }
                else
                {
                    builder.Append(str2 + ",");
        ...
        {
            if (((this.m_FlashUploadType == "shopimg") || this.m_FlashUploadType.Equals("gift")) && this.CheckUploadFileType(text1))
            {
