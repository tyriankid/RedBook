<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZenPointDetail.aspx.cs" Inherits="RedBookPlatform.member.ZenPointDetail" %>
        ...
        <div class="wrapper">
            <div class="crumbs">
                <ul id="breadcrumbs" class="breadcrumb">
                    <li><a href="#">主页</a></li>
                    <li><a href="#">会员管理</a></li>
                    <li class="active"><a href="#" title="">夺宝币消费记录</a></li>
                </ul>
            </div>
                    ...
                    <asp:Repeater runat="server" ID="rptRechargerecord" >
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("usetime","{0:yyyy-MM-dd HH:mm:ss}") %></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
