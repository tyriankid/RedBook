<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSlidesAPP.aspx.cs" validateRequest="false" Inherits="RedBookPlatform.Slides.AddSlidesAPP" %>
		...
		<div class="wrapper">
			<div class="crumbs">
				<ul id="breadcrumbs" class="breadcrumb"> 
	                ...
	                <li class="active"><a href="#" title="">添加APP幻灯片</a></li>
	            </ul>
			</div>
		    <div class="content">
		    	...
		    	<table class="table table-striped tabel-textalign">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="slideorder" id="txtslideorder" runat="server" value="99999" style="" />&nbsp;&nbsp;排序号越小，排位越靠前.</td>
                        </tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td style="width:140px"><span class="red" style="color:red"><strong>*</strong>&nbsp;</span>链接内容：</td>
                            <td>
                                <textarea id ="content"  name="content" runat="server" onblur="setUeditor()"  style="width:100%"></textarea>
                            </td>
                        </tr>
                         <tr>
...
　　<li style="display:inline-block;float:left;width:50px;"><asp:RadioButton   GroupName="state" ID="rbjinyong" Text="禁用" runat="server" /></li>
                          ...
                          <tr>
                            ...
                            <td style="width:140px"><span class="red" style="color:red"><strong>*</strong>&nbsp;</span>活动:</td>
                            <td >
                               
                             <asp:DropDownList ID="ddlactivity" runat="server">
                                    <asp:ListItem Value="" Selected="True">请选择</asp:ListItem>
                                    <asp:ListItem Value="17">冲20送118元</asp:ListItem>
                                    <asp:ListItem Value="18">五折大狂欢</asp:ListItem>
                                    <asp:ListItem Value="19">0元购</asp:ListItem>
                                    <asp:ListItem Value="20">买爆款不中包赔</asp:ListItem>
                                    <asp:ListItem Value="23">首次支付5元不中包赔</asp:ListItem>
...
<%--                                <input type="button" name="name" value="保存" class="btn btn-primary" />--%>
        ...
        <script type="text/javascript">
            ...
            function validation() {
                var flag = true;
                var msg = "";
                if ($("#txtslideorder").val().trim() == "" || $("#thumbImg").attr("src") == "" ) {
                    flag = false; msg = "请设置幻灯片和排序号!";
                }
