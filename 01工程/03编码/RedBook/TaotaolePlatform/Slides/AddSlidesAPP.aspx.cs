...
{
    public partial class AddSlidesAPP : Base
    {
        private int id;
        ...
        protected void load()
        {
            ...
            content.Value = slidesEntity.Slidelink;
            thumbImg.ImageUrl = Globals.UPLOAD_PATH + slidesEntity.Slideimg;

            ddlactivity.SelectedValue = slidesEntity.Activityid.ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
              ...
              int Activityids=0;  //启用
            
                if(ddlactivity.SelectedValue!="")
                {
                    Activityids = Convert.ToInt32(ddlactivity.SelectedValue);
                }
