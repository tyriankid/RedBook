<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SlidesAPP.aspx.cs" Inherits="RedBookPlatform.Slides.SlidesAPP" %>
        ...
        <div class="wrapper">
            <div class="crumbs">
                <ul id="breadcrumbs" class="breadcrumb">
                    ...
                    <li class="active"><a href="#" title="">APP幻灯片管理</a></li>
                </ul>
            </div>
            <div class="content">
                <div class="oprationbtn">
                    <a class="btn" href="javascript:;" onclick="openNewWin('/Slides/AddSlidesAPP.aspx')">添加APP幻灯片</a>
                            ...
                            <ItemTemplate>
                                <tr>
                                  ...
                                  <td><%#Eval("slidelastupdatetime").ToString().Replace("/","-") %></td>
                                    ...
                                    <td style="width:120px;text-align:center" class="opration"><span onclick="openNewWin('/Slides/AddSlidesAPP.aspx?id=<%#Eval("slideid") %>')">修改</span> | <span onclick="goDelete('<%#Eval("slideid") %>')">删除</span></td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                    </tbody>
