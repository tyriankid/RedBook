<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SlidesWechat.aspx.cs" Inherits="RedBookPlatform.Slides.SlidesWechat" %>
        ...
        <div class="wrapper">
            <div class="crumbs">
                <ul id="breadcrumbs" class="breadcrumb">
                    ...
                    <li class="active"><a href="#" title="">微信幻灯片管理</a></li>
                </ul>
            </div>
            <div class="content">
                <div class="oprationbtn">
                    <a class="btn" href="javascript:;" onclick="openNewWin('/Slides/AddSlidesWechat.aspx')">添加微信幻灯片</a>
                        ...
                        <asp:Repeater runat="server" ID="rptAdmin">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="width:120px;text-align:center" class="opration"><span onclick="openNewWin('/Slides/AddSlidesWechat.aspx?id=<%#Eval("slideid") %>')">修改</span> | <span onclick="goDelete('<%#Eval("slideid") %>')">删除</span></td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                    </tbody>
    ...
    <script>
        ...
        function goDelete( id) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json",
                url: "SlidesWechat.aspx/goDelete",
                data: "{id:'" + id + "'}",
                dataType: 'json',
                success: function (result) {
                    alert(result.d);
