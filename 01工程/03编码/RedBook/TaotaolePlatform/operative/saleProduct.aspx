<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="saleProduct.aspx.cs" Inherits="RedBookPlatform.operative.saleProduct" %>
<!DOCTYPE html>
                ...
                if (null != parentId && "" != parentId) {
                    $.getJSON(location.href, { cid: parentId, action: "shoplist" }, function (myJSON) {
                        ...
                        if (myJSON.length > 0) {
                            ...
                            for (var i = 0; i < myJSON.length; i++) {
                                options += "<option value=" + myJSON[i].productid + ">" + myJSON[i].title + "</option>";
                            }
                        }
                        else {
