...
namespace RedBookPlatform.operative
{
    ...
    public partial class updateNewUserRecharge : System.Web.UI.Page
    {
        private int aid = 17;
        ...
        protected void returnlast_Click(object sender, EventArgs e)
        {
            Response.Redirect("/operative/newUserRecharge.aspx", false);
        }
    }
}