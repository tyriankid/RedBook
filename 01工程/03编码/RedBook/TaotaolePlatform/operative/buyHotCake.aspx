<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buyHotCake.aspx.cs" Inherits="RedBookPlatform.operative.buyHotCake" %>
		    	...
		    	<table class="table table-striped tabel-textalign">
                    <tbody>
                            ...
                            <td>
                                分类：<select id="cate" name="cate"> <option value="0">≡ 请选择分类 ≡</option>          
                                  ...
                                  商品：<select id="shop" name="shop" style="margin-right:10px;">
				                    ...
				                    </select><input id="addshoprange" style="padding:2px;" value="添加选中商品" onclick="" type="button" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tboxUsercodeinfo" runat="server"></asp:TextBox>例：“（爆款红包）”
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align:center">
                                 <asp:Button runat="server" ID="btnSave"  class="btn btn-primary" OnClientClick="return validation();" Text="保存" OnClick="btnSave_Click" />&nbsp;&nbsp;
                                </td>
                        </tr>
                    </tbody>
                </table>
