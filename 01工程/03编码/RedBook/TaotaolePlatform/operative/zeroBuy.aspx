<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zeroBuy.aspx.cs" Inherits="RedBookPlatform.operative.zeroBuy" %>
    ...
    <div class="wrapper">
			<div class="crumbs">
				<ul id="breadcrumbs" class="breadcrumb"> 
	                ...
	                <li><a href="javascript:void(0);">0元购活动</a></li>
	                <li class="active"><a href="javascript:void(0);" title=""><asp:Literal runat="server" Text="0元购活动" ID="litTitle"></asp:Literal></a></li>
	            </ul>
			</div></div>
        <div class="content">
		    	...
		    	<table class="table table-striped tabel-textalign">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <input style="padding:2px;" id="timespansadd" value="增加时段"  type="button" />
                                <input style="padding:2px;" id="timespanslistclear" value="清空列表" type="button" /> 
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                分类：<select id="cate" name="cate" style="margin-right:10px;"> <option value="0">≡ 请选择分类 ≡</option>          
                                      </select>            
        ...
        $.getJSON(location.href, { action: "getinfo" }, function (myJSON) {
            ...
            if (timespans.length > 0) {
                ...
                for (var i = 0; i < timespans.length; i++) {
                    timespanshtml += '<input id="timespans[]" name="timespans[]" value="' + timespans[i].starttime + '—' + timespans[i].endtime + '" type="checkbox" checked />&nbsp;' + timespans[i].starttime + '—' + timespans[i].endtime + '<br>';
                }
