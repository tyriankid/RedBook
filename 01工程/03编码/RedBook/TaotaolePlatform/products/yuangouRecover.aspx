<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yuangouRecover.aspx.cs" Inherits="RedBookPlatform.products.yuangouRecover" %>
<%@ Register TagPrefix="UI" Namespace="ASPNET.WebControls" Assembly="ASPNET.WebControls" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <meta charset="UTF-8">
    <title>一元购商品回收站</title>
        ...
        <div class="wrapper">
            <div class="crumbs">
                <ul id="breadcrumbs" class="breadcrumb">
                    <li><a href="#">主页</a></li>
                    <li><a href="#">一元购回收站管理</a></li>
                    <li class="active"><a href="#" title="">一元购商品回收站</a></li>
                </ul>
            </div>
            <div class="content">
                <div class="oprationbtn">
                    <a class="btn" href="javascript:;"  style="<%=display%>" onclick="openNewWin('/products/yuangouList.aspx')">一元购商品列表</a>
                    <div class="search">
                        ...
                        <asp:Repeater runat="server" ID="rptYiyuan">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="<%=display%>"  class="opration"><span onclick="goReturn('<%#Eval("title") %>',<%#Eval("yid") %>)">还原</span> | <span onclick="goRemove('<%#Eval("title") %>',<%#Eval("yid") %>)">删除</span></td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                    </tbody>
