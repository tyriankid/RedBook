<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agentCashout.aspx.cs" Inherits="RedBookPlatform.channel.agentCashout" %>
...
<body>
    <form id="Form1" runat="server">
        <div class="wrapper">
            <div class="crumbs">
                <ul id="breadcrumbs" class="breadcrumb">
                    <li><a href="#">主页</a></li>
                    <li><a href="#">渠道管理</a></li>
                    <li class="active"><a href="#" title="">服务商提现明细</a></li>
                </ul>
            </div>
            <div class="content">
                ...
                <div class="pager oprationbtn">
                       <span style="float:left; padding-left: 0px">当前查询数据汇总:已成功提现总金额<span style="color: green"><%=Allcashoutmoney %></span>元</span>
        ...
        <script>
            //通过服务商提现
            function AdoptApply(id, name, state) {
                var tq;
                tq = (state == '1' ? '通过' : '不通过');
                var con;
