<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Channel.aspx.cs" Inherits="RedBookPlatform.Channel" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	...
	<script src="/Resources/js/channel.js" type="text/javascript" charset="utf-8"></script>
	...
	<div id="top">
		<div class="top-fixed minwidth">
			...
			<ul class="top-menu admin">
				<li><a href="javascript:;"><i class="iconfont icon-guanliyuan"></i><%=this.CurrLoginChannelUser.Username %>[渠道推广员]</a></li>
				<li><a href="Channel.aspx?out=true"><i class="iconfont icon-tuichu-copy"></i>退出</a></li>-
			</ul>
