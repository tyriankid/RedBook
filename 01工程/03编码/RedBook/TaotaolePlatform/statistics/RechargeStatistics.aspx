<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RechargeStatistics.aspx.cs" Inherits="RedBookPlatform.statistics.RechargeStatistics" %>
        ...
        <div class="wrapper">
            ...
            <div class="content">
                ...
                <table class="table table-striped table-even">
                    <thead>
                        <tr>
                            <th style="text-align:center">充值排名</th>
                ...
                <div class="pager oprationbtn">
                    <span style="float:left; padding-left: 0px">当前充值总金额：
