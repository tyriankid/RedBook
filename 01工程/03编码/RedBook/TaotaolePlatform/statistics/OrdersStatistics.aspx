<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdersStatistics.aspx.cs" Inherits="RedBookPlatform.statistics.OrdersStatistics" %>
<!DOCTYPE html>
		...
		<div class="wrapper">
			<div class="crumbs">
				<ul id="breadcrumbs" class="breadcrumb"> 
	                <li><a href="#">主页</a></li>
	                <li><a href="#">消费分析</a></li>
	                <li class="active"><a href="#" title="">新增订单</a></li>
	            </ul>
			</div>
		    <div class="content">
