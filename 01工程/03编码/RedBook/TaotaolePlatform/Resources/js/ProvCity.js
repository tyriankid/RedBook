...
function test(obj) {
    var num, x1, i;
    num = obj.selectedIndex;  //获取选中省份的索引值
    x1 = x[num].split(",");  //获取相应的地区城市列表
    var downlist = $("#DropDownList2"); //获取相应省市的
    downlist.find("option").remove();
    for (var i = 0; i < x1.length; i++) {
        downlist.append("<option value='" + x1[i] + "'>" + x1[i] + "</option>");
        //            downlist.appendChild(new Option(x1[i], x1[i]));
