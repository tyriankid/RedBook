<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResettingPass.aspx.cs" Inherits="RedBookPlatform.admin.ResettingPass" %>
		    ...
		    <div class="content">
                    ...
                    <tbody>
                       ...
                       <%--关于 class="show" 为是否隐藏密码栏目，勿删--%>
                        <tr class="show">
                            <td>原始密码：</td>
                            <td><input id="OldPass" type="password" style="width: 50%;" /></td>
                        </tr>
                        <tr class="show">
                            <td>新 密 码：</td>
                            <td><input id="NewPass" type="password" style="width: 50%;" /></td>
                        </tr>
                        <tr>
                            <td>再次输入：</td>
                            <td><input id="okNewPass" type="password" style="width: 50%;"  /></td>
                        </tr>
                        <tr>
                            <td colspan="2">
