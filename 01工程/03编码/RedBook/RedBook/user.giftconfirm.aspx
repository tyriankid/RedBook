<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user.giftconfirm.aspx.cs" Inherits="RedBook.user_GiftConfirm" %>
...
<body>
    <header class="header">
        <h2>中奖确认</h2>
        <a class="cefenlei" href="/user.giftlist.aspx">
    ...
    <section class="fixbox">
        <div class="fixnr"><span>手气不错哦！</span><a class="link-canyu" href="gift.index.aspx">继续参与</a></div>
    </section>
    ...
    <script type="text/javascript">
        ...
        function GetGoodsInfo() {
            var ajaxUrl = "http://" + window.location.host + "/ilerrshareorder?action=giftConfirm&orderid=" + orderid + "&shopid=" + shopid;
            //alert(ajaxUrl);
            var goodsinfo = "",
                status = "";
            $.ajax({
            ...
            var GetHuafeili = '<li id="yipaifa">' +
               ...
               // '<a class="arrtxt blue" href="/user.chongzhiInfo.aspx">卡密使用说明<i class="z-arrow"></i></a>' +
                ...
                '<div class="kuang">' +
                    ...
                    '<div class="knr">密码：' + e.kami.replace(e.kami.substring(6, 10), "****") + '</div>' +
                '</div>' +
            '</li>' +
            '<li id="ShiyongWay">' +
        ...
        function WuMorenAddr() {
            return '<li>' +
                    '<h1>请确认收货地址</h1>' +
                    '<p>您还没有默认的收货地址</p>' +
                    '<a class="btn-style" id="selectAddr" href="/user.address.aspx?orderid=' + orderid + '&shopid=' + shopid + '&productid=' + productid + '&pageFrom=giftConfirm">新增收货地址</a>' +
                '</li>'
        }
