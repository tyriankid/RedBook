    ...
    public class AppWxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            inputObj.SetValue("spbill_create_ip", AppWxPayConfig.IP);//终端ip
            inputObj.SetValue("appid", AppWxPayConfig.APPID);//公众账号ID
            inputObj.SetValue("mch_id", AppWxPayConfig.MCHID);//商户号
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            inputObj.SetValue("appid", AppWxPayConfig.APPID);//公众账号ID
            inputObj.SetValue("mch_id", AppWxPayConfig.MCHID);//商户号
            inputObj.SetValue("nonce_str", AppWxPayApi.GenerateNonceStr());//随机字符串
            inputObj.SetValue("sign", inputObj.MakeSign());//签名
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, bool isWeixinJS = true, int timeOut = 6)
        {
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            {
                inputObj.SetValue("notify_url", AppWxPayConfig.NOTIFY_URL);//异步通知url
            }
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj, int timeOut = 1)
        {
            ...
            inputObj.SetValue("appid", AppWxPayConfig.APPID);//公众账号ID
            inputObj.SetValue("mch_id", AppWxPayConfig.MCHID);//商户号
            inputObj.SetValue("user_ip", AppWxPayConfig.IP);//终端ip
        ...
        */
        ...
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}", AppWxPayConfig.MCHID, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999));
        }
