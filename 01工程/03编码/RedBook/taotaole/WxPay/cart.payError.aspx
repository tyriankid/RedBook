<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cart.payError.aspx.cs" Inherits="RedBook.cart_payError" %>
...
<body>
    ...
    <section id="shopResultBox" class="clearfix">
        <div class="g-pay-auto">
            <img style="width: 50%; display: block; margin: 30px auto 0 auto;" src="/images/discover/payerror.png" />
            <div class="z-pay-tips"><b><em class="gray6">支付失败,金额将退到您的微信客户端!</em></b></div>
        </div>
        <div class="u-BtnBox">
            <div class="u-Btn">
